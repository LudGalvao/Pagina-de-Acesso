...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [MatToolbarModule, MatIconModule, MatButtonModule,MatSidenavModule, FormsModule, RouterOutlet, CommonModule, MatListModule, RouterLink, RouterLinkActive,AcessoLateralComponent, AcessoPrincipalComponent],
